              ...
              <div key={element._id}>
                ...
                <div className="row">
                  {element.files.map((file, index) =>
                    <div >
                      <div className="card mb-2 border-0 p-0">
                      {index === main  ?      <img src={`http://localhost:8080/${file.filePath}`} height="450"  className="card-img-top img-responsive" alt="img" />:null}
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="row">
                  {element.files.map((file, index) =>
                    <div className="col-2">
                      ...
                      <div className="card mb-2 border-0 p-0">
                        <img src={`http://localhost:8080/${file.filePath}`} onClick={()=>setMain(index)} height="200" className="card-img-top img-responsive" alt="img" />
                      </div>
                    </div>
                  )}
                </div>
